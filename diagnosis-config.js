...
window.REVIA_DIAGNOSIS_CONFIG = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { id: "veryWeak", label: "かなり苦手", scores: { individual: 3, inPersonTutor: 3, onlineTutor: 2 } },
        { id: "belowAverage", label: "平均より下", scores: { individual: 3, onlineTutor: 2, inPersonTutor: 2 } },
        ...
        { id: "topAim", label: "上位を目指している", scores: { self: 2, group: 2, onlineTutor: 2 } },
      ],
    },
    {
      id: "mainConcern",
      ...
      options: [
        { id: "habit", label: "勉強習慣", scores: { inPersonTutor: 3, onlineTutor: 2, individual: 2 } },
        { id: "test", label: "定期テスト", scores: { group: 2, individual: 3, onlineTutor: 2 } },
        { id: "exam", label: "受験対策", scores: { group: 2, individual: 2, onlineTutor: 3 } },
        { id: "weakness", label: "苦手克服", scores: { individual: 3, onlineTutor: 3, inPersonTutor: 2 } },
        { id: "method", label: "勉強方法", scores: { onlineTutor: 3, individual: 2, self: 1 } },
        { id: "schoolPace", label: "学校の授業についていきたい", scores: { individual: 3, inPersonTutor: 2, onlineTutor: 2 } },
        { id: "topSchool", label: "上位校・難関校対策", scores: { group: 2, onlineTutor: 3, self: 2 } },
      ],
    },
    {
      id: "homeStudy",
      ...
      options: [
        ...
        { id: "oneTwo", label: "週1〜2日", scores: { individual: 2, onlineTutor: 2 } },
        { id: "threeFour", label: "週3〜4日", scores: { group: 2, onlineTutor: 2, self: 1 } },
        { id: "daily", label: "ほぼ毎日", scores: { self: 3, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "barely", label: "なんとか出す", scores: { individual: 2, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "answer", label: "答えを見る", scores: { individual: 2, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        { id: "whatToDo", label: "何をすればいいか分からない", scores: { onlineTutor: 3, individual: 3, inPersonTutor: 2 } },
        { id: "continue", label: "続かない", scores: { inPersonTutor: 3, onlineTutor: 2, individual: 2 } },
        { id: "understoodButNo", label: "分かったつもりで解けない", scores: { individual: 3, onlineTutor: 3 } },
        { id: "memory", label: "暗記が苦手", scores: { group: 1, individual: 2, onlineTutor: 2 } },
        { id: "application", label: "応用問題が苦手", scores: { onlineTutor: 3, individual: 2, group: 1 } },
        { id: "noTime", label: "時間が足りない", scores: { onlineTutor: 3, self: 1 } },
      ],
    },
    {
      id: "methodConfidence",
      ...
      options: [
        { id: "none", label: "ない", scores: { onlineTutor: 3, individual: 2 } },
        { id: "little", label: "あまりない", scores: { individual: 2, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "oneToOne", label: "1対1がよい", scores: { onlineTutor: 3, inPersonTutor: 3, individual: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "hard", label: "集中しにくい", scores: { onlineTutor: 2, inPersonTutor: 2, individual: 1 } },
      ],
    },
    {
      id: "asking",
      ...
      options: [
        ...
        { id: "weak", label: "苦手", scores: { individual: 3, inPersonTutor: 2, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        { id: "much", label: "かなり見てほしい", scores: { inPersonTutor: 3, onlineTutor: 3, individual: 2 } },
        { id: "some", label: "ある程度見てほしい", scores: { individual: 2, onlineTutor: 2 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "weak", label: "苦手", scores: { onlineTutor: 3, individual: 2 } },
        { id: "none", label: "ほとんどできない", scores: { inPersonTutor: 3, onlineTutor: 2, individual: 2 } },
      ],
    },
    {
      id: "quietPlace",
      ...
      options: [
        ...
        { id: "notMuch", label: "あまりない", scores: { group: 2, individual: 2, inPersonTutor: 1 } },
        { id: "none", label: "ない", scores: { group: 3, individual: 2 } },
      ],
    },
    {
      id: "device",
      ...
      options: [
        ...
        { id: "anxious", label: "少し不安", scores: { individual: 1, inPersonTutor: 1 } },
        { id: "difficult", label: "難しい", scores: { group: 2, individual: 2, inPersonTutor: 2 } },
      ],
    },
    {
      id: "zoom",
      ...
      options: [
        ...
        { id: "little", label: "少しある", scores: { onlineTutor: 1, individual: 1 } },
        { id: "strong", label: "かなりある", scores: { inPersonTutor: 2, individual: 2 } },
        { id: "never", label: "使ったことがない", scores: { individual: 1, inPersonTutor: 1 } },
      ],
    },
    {
      id: "screenFocus",
      ...
      options: [
        ...
        { id: "anxious", label: "少し不安", scores: { individual: 2, inPersonTutor: 1 } },
        { id: "veryAnxious", label: "かなり不安", scores: { inPersonTutor: 3, individual: 2 } },
      ],
    },
    {
      id: "onlineHomework",
      ...
      options: [
        ...
        { id: "little", label: "少しある", scores: { onlineTutor: 1, individual: 1 } },
        { id: "strong", label: "かなりある", scores: { inPersonTutor: 2, individual: 2 } },
        { id: "unknown", label: "分からない", scores: { individual: 1, onlineTutor: 1 } },
      ],
    },
    {
      id: "parentStatus",
      ...
      options: [
        ...
        { id: "little", label: "あまり把握していない", scores: { inPersonTutor: 2, individual: 2, onlineTutor: 1 } },
    ...
    },
    {
      ...
      options: [
        ...
        { id: "hard", label: "かなり難しい", scores: { group: 2, individual: 2 } },
      ],
    },
    {
      id: "supportLevel",
      ...
      options: [
        ...
        { id: "weekly", label: "週1で整えたい", scores: { onlineTutor: 2, individual: 2 } },
        { id: "careful", label: "しっかり伴走してほしい", scores: { onlineTutor: 3, individual: 2, inPersonTutor: 2 } },
        { id: "veryCareful", label: "かなり手厚く見てほしい", scores: { inPersonTutor: 3, onlineTutor: 3, individual: 2 } },
      ],
    },
    {
      id: "deadline",
      ...
      options: [
        { id: "oneMonth", label: "1か月以内", scores: { individual: 2, onlineTutor: 2, inPersonTutor: 1 } },
        { id: "nextTest", label: "次の定期テストまで", scores: { individual: 2, group: 1, onlineTutor: 2 } },
        { id: "threeMonths", label: "3か月以内", scores: { onlineTutor: 2, individual: 1 } },
        { id: "halfYear", label: "半年以上かけて", scores: { self: 1, group: 1, onlineTutor: 1 } },
        { id: "exam", label: "受験まで", scores: { group: 2, onlineTutor: 2, individual: 1 } },
      ],
    },
  ],
};
